...
'Сравнивает входную переменную с заголовком'
WebUI.verifyElementText(findTestObject('Three test(задание)/In page WoW Classic'), W, FailureHandling.CONTINUE_ON_FAILURE)
